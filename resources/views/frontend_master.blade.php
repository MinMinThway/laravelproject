...
<head>
	...
	<link rel="icon" type="{{asset('frontend_assets/image/png')}}" sizes="192x192"  href="{{asset('frontend_assets/../favicon/android-icon-192x192.png')}}">
	<link rel="icon" type="{{asset('frontend_assets/image/png')}}" sizes="32x32" href="{{asset('frontend_assets/../favicon/favicon-32x32.png')}}">
	<link rel="icon" type="{{asset('frontend_assets/image/png')}}" sizes="96x96" href="{{asset('frontend_assets/../favicon/favicon-96x96.png')}}">
	<link rel="icon" type="{{asset('frontend_assets/image/png')}}" sizes="16x16" href="{{asset('frontend_assets/../favicon/favicon-16x16.png')}}">
...
<body>
    ...
    <script type="text/javascript" src="{{asset('frontend_assets/js/min.js')}}"></script>
