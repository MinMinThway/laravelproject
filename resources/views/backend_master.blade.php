    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item{{Request::is('dashboard')?'active':''}}" href="{{route('dashboard')}}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
         <li><a class="app-menu__item{{Request::is('categories*') ? 'active' :''}}" href="{{route('categories.index')}}"><i class="icon fa fa-circle-o"></i>Category Page</a></li>

            <li><a class="app-menu__item{{Request::is('brands')?'active':''}}" href="{{route('brands.index')}}"><i class="icon fa fa-circle-o"></i>Brand Page</a></li>

             <li><a class="app-menu__item{{Request::is('subcategories')?'active':''}}" href="{{route('subcategories.index')}}"><i class="icon fa fa-circle-o"></i>Subcategories Page</a></li>

            <li><a class="app-menu__item{{Request::is('items')?'active':''}}" href="{{route('items.index')}}"><i class="icon fa fa-circle-o"></i>Item Page</a></li>
